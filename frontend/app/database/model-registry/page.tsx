        ...
        <div className="container mx-auto max-w-5xl px-4 py-16 sm:py-24">
          <div className="mb-12">
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
              ファインチューニング済みのモデルの閲覧・管理を行います。
            </p>
          </div>
          <div className="rounded-xl bg-white dark:bg-gray-800/50 p-8 shadow-lg">
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-white">学習済みモデル一覧</h2>
            <div className="mt-6 h-64 flex items-center justify-center rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600">
              <p className="text-gray-400">（ここにモデル一覧テーブルなどを実装します）</p>
            </div>
          </div>
          <div className="mt-12">
