...
export default function PreprocessorPage() {
  ...
  // sortByの型と初期値を変更
  const [sortBy, setSortBy] = useState<'state' | 'target_method' | 'ID' | 'created_at'>('created_at');
          ...
          <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 space-y-4">
            ...
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              <div className="lg:w-48">
                <select value={`${sortBy}-${sortOrder}`} onChange={(e) => { const [field, order] = e.target.value.split('-'); setSortBy(field as 'state' | 'target_method' | 'ID' | 'created_at'); setSortOrder(order as 'asc' | 'desc'); }} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent">
